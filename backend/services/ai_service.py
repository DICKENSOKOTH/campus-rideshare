...
def get_chat_response(
    ...
    from ai.assistant import get_chat_response as _get_chat_response
...
def get_quick_suggestions() -> List[str]:
    ...
    from ai.assistant import get_quick_suggestions as _get_suggestions
    return _get_suggestions()


def get_initial_greeting() -> str:
    """Get the initial greeting for the chat UI."""
    from ai.assistant import get_initial_greeting as _get_greeting
